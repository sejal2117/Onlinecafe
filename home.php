...
<section class="category">
   ...
   <div class="box-container">
      ...
      <a href="category.php?category=Quick Bites" class="box">
         <img src="images/fries.jpg" alt="">
         <h3>Quick Bites</h3>
      </a>

      <a href="category.php?category=Coffee" class="box">
         <img src="images/coffee Crush.jpg" alt="">
         <h3>Coffee</h3>
      </a>
      ...
      <a href="category.php?category=Momos" class="box">
   ...
   <div class="box-container">
      ...
      <form action="" method="post" class="box">
         ...
         <div class="flex">
            ...
            <input type="number" name="qty" class="qty" min="1" max="99" value="0" maxlength="5">
         </div>
      </form>
      <?php
            }
